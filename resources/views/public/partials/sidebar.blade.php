...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="{{ (Route::currentRouteName() == 'user.dashboard' ) ? 'active' : '' }} nav-item">
            ...
            <li class="{{ (Route::currentRouteName() == 'compagin' ) ? 'active' : '' }} nav-item">
                <a href="{{ Route('compagin') }}">
                    <i class="feather icon-campaign"></i><span class="menu-title">Start Campaign</span>
                </a>
            </li>
