...
@include('layouts.navbar')
    ...
    <div id="main-carousel" class="carousel slide" data-ride="carousel" style="position: relative;">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="main-caroousel-images" src="{{ asset('images/1.png') }}" height="480" style="background: orange;" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="main-caroousel-images" src="{{ asset('images/2.jpg') }}" height="480" style="background: red;" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="main-caroousel-images" src="{{ asset('images/3.jpg') }}" height="480" style="background: blue;" alt="Third slide">
        </div>
      </div>
      <div id="main-slider-featured">
        <div class="main-slider-featured-details">
          ...
          <p id="main-slider-featured-details-featured-heading">Avarax-E - Self-Cleaning & Most Affordable E-bike</p>
        ...
        <div id="main-carousel-controls">
          <a href="#main-carousel" role="button" data-slide="prev">
            <div id="main-carousel-controls-left" class="main-carousel-controls-dir">
                ...
                <svg viewBox="0 0 8 12" id="main-carousel-controls-left-caret" class="main-carousel-controls-dir-caret"><path d="M7.294 2.706a.997.997 0 00-.005-1.417L6.711.711a1.01 1.01 0 00-1.423 0L.712 5.289a1.01 1.01 0 000 1.424l4.576 4.576a1 1 0 001.423.001l.578-.578a1 1 0 00.005-1.417L4 6l3.294-3.294z"></path></svg>
          ...
          <a href="#main-carousel" role="button" data-slide="next">
            <div id="main-carousel-controls-right" class="main-carousel-controls-dir">
                ...
                <svg viewBox="0 0 8 12" id="main-carousel-controls-right-caret" class="main-carousel-controls-dir-caret"><path d="M.706 9.294a.997.997 0 00.005 1.417l.578.578a1.01 1.01 0 001.423 0l4.576-4.577a1.01 1.01 0 000-1.424L2.712.712A1 1 0 001.289.71l-.578.578a1 1 0 00-.005 1.417L4 6 .706 9.294z"></path></svg>
      ...
      <div id="main-slider-signup-ad">
        ...
        <div id="main-slider-signup-ad-buttons">
          ...
          <a href="#">
            <div id="main-slider-signup-ad-button2">
              Learn More
            </div>
          </a>
        </div>
                ...
                <div class="popular-projects-card-details">
                  <div class="popular-projects-card-details-header">
                    ...
                    <div class=" popular-projects-card-details-header-save">
                      <svg viewBox="0 0 20 20" class="popular-projects-card-details-header-save-heart">
          ...
          <div class="col-3" >
            <div class="popular-projects-card">
              <a href="{{ url('project') }}">
                <!-- Card Image -->
                <div class="pouplar-projects-card-img">
                  <img style="width: 100%;" src="https://c4.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fit,w_auto,g_center,q_auto:best,dpr_1.3,f_auto/kj62idppsudcimru1ogc" alt="">
                </div>
          ...
          <div class="col-3" >
            <div class="popular-projects-card">
              <a href="{{ url('project') }}">
                <!-- Card Image -->
                <div class="pouplar-projects-card-img">
                  <img style="width: 100%;" src="https://c4.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fit,w_auto,g_center,q_auto:best,dpr_1.3,f_auto/zirrjrzq3fs5jkjgxhvt" alt="">
                </div>
          ...
          <div class="col-3" >
            <div class="popular-projects-card">
              <a href="{{ url('project') }}">
                <!-- Card Image -->
                <div class="pouplar-projects-card-img">
                  <img style="width: 100%;" src="https://c0.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fit,w_auto,g_center,q_auto:best,dpr_1.3,f_auto/ghwerjr3na3znryawhyr" alt="">
                </div>
      ...
      <div class="row" class="trendings-cards">
        ...
        <div class="col-6 trendings-card-container" >
          <div class="trendings-card">
            ...
            <div class="trendings-main-image">
              <img class="trendings-main-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1614035747/fkbuqo1rtawruhntjdvk.jpg" alt="">
            </div>
            <a href="#">
            ...
            <a href="#">
              <div class="trendings-card-see-collection">SEE THE COLLECTION &nbsp;<svg viewBox="0 0 8 12" style="height: 11px;position:relative;top:-1px" id="v-right_caret"><path d="M.706 9.294a.997.997 0 00.005 1.417l.578.578a1.01 1.01 0 001.423 0l4.576-4.577a1.01 1.01 0 000-1.424L2.712.712A1 1 0 001.289.71l-.578.578a1 1 0 00-.005 1.417L4 6 .706 9.294z"></path></svg></div>
            </a>
        ...
        <div class="col-6 trendings-card-container" >
          <div class="trendings-card">
            ...
            <div class="trendings-main-image">
              <img class="trendings-main-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1613763241/lmiafrufd5hv6nu31095.png">
            </div>
            <a href="#">
              <div class="trendings-card-overlay"></div>
            </a>
        ...
        <div class="col-6 trendings-card-container" >
          <div class="trendings-card">
            ...
            <div class="trendings-main-image">
              <img class="trendings-main-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1610645828/srw2ffyyagzenfu6pznr.png" alt="">
            </div>
            <a href="#">
              <div class="trendings-card-overlay"></div>
            </a>
        ...
        <div class="col-6 trendings-card-container" >
          <div class="trendings-card">
              ...
              <div class="trendings-main-image">
                <img class="trendings-main-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1597692648/t5nvsqhmxvwgk8cgrtac.png" alt="">
              </div>
            <a href="">
              <div class="trendings-card-overlay"></div>
            </a>
  ...
  <section id="info-banner">
    <div class="container">
      <div id="info-banner-main-image">
        <img id="info-banner-main-image-img" src="https://c4.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fit,w_auto,g_center,q_auto:best,dpr_1.3,f_auto/homepage/crowdfunding-bg-desktop-lg.jpg" alt="">
      </div>
      <div id="info-banner-body">
        ...
        <a href="#">
          <div id="info-banner-body-learn">
            LEARN ABOUT CROWDFNDING &nbsp;<svg viewBox="0 0 8 12" style="height: 13px;position:relative;top:-2px" id="v-right_caret"><path d="M.706 9.294a.997.997 0 00.005 1.417l.578.578a1.01 1.01 0 001.423 0l4.576-4.577a1.01 1.01 0 000-1.424L2.712.712A1 1 0 001.289.71l-.578.578a1 1 0 00-.005 1.417L4 6 .706 9.294z"></path></svg>
          </div>
        </a>
        ...
        <div class="row" id="categories-body-categories">
          ...
          <div class="col-2" >
            <a href="#">
              <div class="categories-body-category">
                <div class="categories-body-category-image">
                  <svg viewBox="0 0 150 150" style="height: 65px;" id="v-homepage_phones_accessories"><path class="phone0" d="M118.4 5.4l-86.6-.1c-.6 0-1.1.5-1.1 1.1v31.1l-.1 106c0 .6.5 1.1 1.1 1.1h16l70.6.1c.6 0 1.1-.5 1.1-1.1v-31l.1-106.2c-.1-.5-.5-1-1.1-1zm-50 6.2c0-.5.4-1 1-1h11.3c.5 0 1 .4 1 1v2.5c0 .5-.4 1-1 1H69.4c-.5 0-1-.4-1-1v-2.5zm-30.6.3c.4-2.5 3.2-3.8 5.4-2.5 1.2.7 1.9 2.2 1.7 3.6-.4 2.5-3.2 3.8-5.4 2.5-1.3-.7-1.9-2.2-1.7-3.6zm42.3 123c-.4 2.2-2.2 4-4.5 4.4-3 .6-5.7-1.2-6.5-3.9-.3-.9-.3-1.8-.1-2.8.4-2.2 2.2-4 4.5-4.4 2.6-.5 4.9.8 6.1 2.9.6 1.1.8 2.4.5 3.8zm31.7-28.6v14.3h-7.4l-66.2-.1.1-76.7V20.9l73.6.1-.1 85.3z"></path><circle fill="#fff" transform="rotate(-89.942 74.591 133.82)" class="phone1" cx="74.6" cy="133.8" r="5.7"></circle><path d="M118.4 5.4l-86.6-.1c-.6 0-1.1.5-1.1 1.1v31.1l7.5 6.4V21l73.6.1-.1 85.2 7.5 6.4.1-106.2c.1-.6-.3-1.1-.9-1.1zM44.9 13c-.4 2.5-3.2 3.8-5.4 2.5-1.2-.7-1.9-2.2-1.7-3.6.4-2.5 3.2-3.8 5.4-2.5 1.3.7 1.9 2.2 1.7 3.6zm36.8 1.1c0 .5-.4 1-1 1H69.4c-.5 0-1-.4-1-1v-2.5c0-.5.4-1 1-1h11.3c.5 0 1 .4 1 1v2.5z" fill="#eb1478"></path><path fill="#fff" class="phone1" d="M74.6 128.2c-3.1 0-5.7 2.5-5.7 5.7 0 .6.1 1.2.3 1.7l10.4-4.4c-1-1.8-2.9-3-5-3z"></path><path d="M69 132.7c.4-2.2 2.2-4 4.5-4.4 2.6-.5 4.9.8 6.1 2.9l24.8-10.5-66.2-.1.1-76.7-7.5-6.4-.1 106c0 .6.5 1.1 1.1 1.1h16l21.6-9.1c-.5-.9-.6-1.8-.4-2.8zm50.3-20l-7.5-6.4v11.2l7.5-3.2z" fill="#bf106e"></path><path fill="#bf106e" class="phone0" d="M119.3 143.6v-29.3l-7.5 3.2v3.1h-7.4l-24.8 10.5c.6 1.1.8 2.4.6 3.8-.4 2.2-2.2 4-4.5 4.4-3 .6-5.7-1.2-6.5-3.9l-21.6 9.1 70.6.1c.6.1 1.1-.4 1.1-1z"></path></svg>
                </div>
              ...
              <div class="categories-body-category">
                <div class="categories-body-category-image">
                  <svg viewBox="0 0 150 150" style="width: 65px;" id="v-homepage_travel_outdoors">
                    <path class="travel2" d="M124.31 129.295l-2.733-58.294-.234-5.939a46.178 46.178 0 00-5.937-20.934c-3.477-6.162-11.412-12.983-14.244-14.806-2.832-1.823-5.744-3.5-8.894-4.764 0-.055.003-.11.003-.164 0-.19-.018-.368-.022-.555-.231-12.198-7.923-19.983-17.366-19.983-9.467 0-17.176 7.824-17.37 20.075-.002.156-.017.304-.017.462 0 .085.004.169.005.254-3.143 1.282-5.557 2.781-8.865 4.816S37.878 38.22 34.43 44.44a46.17 46.17 0 00-5.765 20.622l-.18 4.55-.056 1.396-2.734 58.287c-.05 1.266.059 2.499.287 3.69 1.424 7.463 7.973 13.156 15.907 13.156h66.225c7.934 0 14.483-5.693 15.907-13.155.043-.227.062-.46.096-.69.127-.86.207-1.733.194-2.63-.002-.124.001-.247-.004-.372zM64.044 21.83c.863-7.545 5.47-11.584 10.841-11.584 5.36 0 9.957 4.011 10.835 11.53.029.242.065.478.085.729a46.435 46.435 0 00-10.798-1.275h-.004c-3.803 0-7.5.464-11.042 1.33.02-.25.055-.487.083-.73zM83.003 52.5a8 8 0 11-16 0 8 8 0 0116 0zm-45.449 42a1.225 1.225 0 01-1.224-1.225v-3.55c0-.677.548-1.225 1.224-1.225h75.55c.676 0 1.224.548 1.224 1.225v3.55c0 .677-.55 1.225-1.225 1.225h-75.55zm15.737 16v5.851c0 .6-.486 1.086-1.086 1.086h-4.214c-.6 0-1.087-.486-1.087-1.086v-10.199c0-.822.487-1.489 1.086-1.489h54.039c.6 0 1.086.667 1.086 1.489v2.86c0 .821-.486 1.488-1.086 1.488H53.292z"></path>
                    <path class="travel2" d="M28.26 15.298l2.92 20.524a.495.495 0 00.904.205 46.55 46.55 0 0113.852-13.159.988.988 0 00.464-.982l-.15-1.05-1.705-11.984a2.17 2.17 0 00-2.455-1.846L29.529 8.793a2.172 2.172 0 00-1.845 2.457l.576 4.048zm75.607 8.402a46.565 46.565 0 0113.838 13.041c.26.374.836.244.902-.207l1.608-11.096 1.907-13.164a2.172 2.172 0 00-1.84-2.462l-12.555-1.82a2.173 2.173 0 00-2.462 1.839l-.823 5.677-1.044 7.205a.99.99 0 00.467.986z"></path>

                    <path class="travel1" fill="#fff" d="M114.33 93.275v-3.55c0-.677-.548-1.225-1.225-1.225H58.532c3.124 1.96 6.323 3.964 9.572 6h45.002c.676 0 1.225-.548 1.225-1.225z"></path>
                    <circle class="travel1" fill="#fff" cx="75.004" cy="52.5" r="8"></circle>
                    <path fill="#fff" class="travel1" d="M103.115 109.011v-2.859c0-.822-.486-1.489-1.086-1.489H84.33l9.327 5.837h8.37c.6 0 1.087-.667 1.087-1.489zM75.005 21.23c3.717 0 7.33.446 10.8 1.275-.021-.25-.057-.487-.086-.73-.878-7.518-5.475-11.529-10.834-11.529-5.372 0-9.979 4.04-10.842 11.584-.027.244-.063.48-.083.73A46.423 46.423 0 0175 21.23h.005z"></path>
                    <path fill="#eb1478" class="travel3" d="M113.105 88.5c.676 0 1.225.548 1.225 1.225v3.55c0 .677-.549 1.225-1.225 1.225H68.103c5.322 3.335 10.77 6.747 16.228 10.163h17.698c.6 0 1.086.667 1.086 1.489v2.86c0 .821-.486 1.488-1.086 1.488h-8.37a68844.717 68844.717 0 0030.655 19.168c-.002-.124.002-.247-.003-.373l-2.734-58.294-.235-5.939a46.18 46.18 0 00-5.937-20.934c-3.478-6.162-11.412-12.983-14.244-14.806s-5.744-3.5-8.894-4.764c0-.055.003-.11.003-.164 0-.19-.018-.368-.022-.555-.231-12.198-7.923-19.983-17.366-19.983-9.467 0-17.176 7.824-17.37 20.075-.001.156-.017.305-.017.462 0 .085.004.169.005.254-3.143 1.282-5.557 2.781-8.865 4.816S37.878 38.22 34.43 44.44a46.172 46.172 0 00-5.766 20.622l-.18 4.55c8.037 5.07 18.517 11.656 30.047 18.887h54.574zm-38.101-28a8 8 0 110-16 8 8 0 010 16zm-10.96-38.671c.862-7.545 5.469-11.584 10.84-11.584 5.36 0 9.957 4.011 10.835 11.53.029.242.065.478.085.729a46.434 46.434 0 00-10.798-1.276H75c-3.802 0-7.5.464-11.041 1.33.019-.25.055-.486.083-.729z"></path>
                    <path class="travel2" d="M124.314 129.668c-9.313-5.82-19.854-12.41-30.656-19.168H53.291v5.851c0 .6-.486 1.086-1.086 1.086H47.99c-.6 0-1.086-.486-1.086-1.086v-10.199c0-.822.487-1.489 1.086-1.489h36.341A34563.96 34563.96 0 0168.103 94.5H37.555a1.225 1.225 0 01-1.225-1.225v-3.55c0-.677.548-1.225 1.225-1.225H58.53a13267.05 13267.05 0 01-30.046-18.888l-.055 1.397-2.734 58.286a16.22 16.22 0 00.287 3.691c1.425 7.462 7.973 13.156 15.908 13.156h31.794l50.435-13.845c.128-.859.208-1.732.195-2.628z" fill="#ab005f"></path>
                    <path d="M124.024 132.986c.043-.226.062-.46.096-.689l-50.435 13.845h34.431c7.935 0 14.484-5.693 15.908-13.155z" fill="#ab005f"></path>
                    <path class="travel3" fill="#eb1478" d="M44.547 8.85a2.172 2.172 0 00-2.457-1.844L29.53 8.793a2.173 2.173 0 00-1.846 2.457l.577 4.048 17.991 5.536-1.705-11.983z"></path>
                    <path class="travel2" d="M32.085 36.028a46.55 46.55 0 0113.852-13.16.988.988 0 00.465-.982l-.15-1.05-17.991-5.537 2.92 20.523a.496.496 0 00.904.206z" fill="#ab005f"></path>
                    <path class="travel3" fill="#eb1478" d="M122.123 12.274a2.172 2.172 0 00-1.839-2.462l-12.556-1.82a2.173 2.173 0 00-2.462 1.839l-.822 5.677 15.771 9.93 1.908-13.164z"></path>
                    <path class="travel2" d="M103.867 23.7a46.563 46.563 0 0113.838 13.041c.26.374.836.244.902-.207l1.608-11.096-15.772-9.93-1.044 7.205a.99.99 0 00.467.987z" fill="#ab005f" ></path>
              ...
              <div class="categories-body-category">
                <div class="categories-body-category-image">
                  <svg viewBox="0 0 150 150" style="width: 65px;" id="v-homepage_audio">
                    ...
                    <path fill="#fff" class="audio1" d="M42.913 102.858c0 17.721 14.366 32.087 32.087 32.087s32.087-14.366 32.087-32.087c0-3.501-.568-6.867-1.605-10.022L71.418 70.975c-16.034 1.781-28.505 15.373-28.505 31.883zm32.085-10.034c5.621 0 10.178 4.557 10.178 10.178 0 5.62-4.557 10.178-10.178 10.178s-10.178-4.557-10.178-10.178c0-5.622 4.557-10.178 10.178-10.178z"></path>
                    <circle class="audio2" cx="74.998" cy="103.002" r="10.178" fill="#eb1478"></circle>
                    <path class="audio3" d="M120.5 6.142h-91a1 1 0 00-1 1V43.43l42.918 27.544c1.177-.13 2.37-.203 3.582-.203 14.22 0 26.272 9.254 30.482 22.066l16.018 10.28V7.142a1 1 0 00-1-1zM62.296 57.696C49.857 58.928 39.489 48.56 40.721 36.12c.911-9.205 8.357-16.65 17.561-17.562 12.44-1.232 22.807 9.136 21.575 21.575-.911 9.205-8.357 16.65-17.561 17.562z" fill="#eb1478"></path>
                    <circle class="audio3" cx="60.289" cy="38.128" r="5.338" fill="#eb1478"></circle>
                    <path fill="#ab005f" class="audio2" d="M121.5 103.117l-16.018-10.28a32.038 32.038 0 011.605 10.02c0 1.944-.182 3.844-.513 5.692l14.926-4.907v-.525zm-78.587-.26c0-16.51 12.47-30.1 28.505-31.883L28.5 43.43v90.787l24.468-8.044c-6.188-5.85-10.055-14.128-10.055-23.315z"></path>
                    <path fill="#ab005f" class="audio0" d="M29.5 143.858h91a1 1 0 001-1v-39.216l-14.926 4.907c-2.688 15.005-15.796 26.396-31.574 26.396-8.534 0-16.284-3.338-22.032-8.772L28.5 134.217v8.64a1 1 0 001 1z"></path>
                  </svg>
                </div>
  ...
  <section id="journal">
    <div class="container">
      <div id="journal-header">
        ...
        <div id="journal-header-description">Your behind-the-scenes view of the people and stories behind Indiegogo projects</div>
      </div>
      <div id="journal-body">
        <div id="journal-cards">
          <div class="row">
            ...
            <div class="col-4 journal-card">
              <a href="#">
                <div class="journal-card-image">
                  <img class="journal-card-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1613783147/nrq4pzyxfmwivcxldvlm.png" alt="">
                </div>
              </a>
              ...
              <div class="journal-card-details">
                ...
                <a href="#">
                  <div class="journal-card-details-read">
                    Read More <svg viewBox="0 0 8 12" style="height: 10px;" id="v-right_caret"><path d="M.706 9.294a.997.997 0 00.005 1.417l.578.578a1.01 1.01 0 001.423 0l4.576-4.577a1.01 1.01 0 000-1.424L2.712.712A1 1 0 001.289.71l-.578.578a1 1 0 00-.005 1.417L4 6 .706 9.294z"></path></svg>
                  </div>
                </a>
            ...
            <div class="col-4 journal-card">
              <a href="#">
                <div class="journal-card-image">
                  <img class="journal-card-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1613783543/insjvndarpap36v2dh12.jpg" alt="">
                </div>
              </a>
              <div class="journal-card-details">
                <div class="journal-card-details-heading">
            ...
            <div class="col-4 journal-card">
              <a href="#">
                <div class="journal-card-image">
                  <img class="journal-card-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/f_auto/v1614102019/y53643otrzpgpndgweey.png" alt="">
                </div>
              </a>
              <div class="journal-card-details">
                <div class="journal-card-details-heading">
  ...
  <section id="clever">
    <div class="container">
      ...
      <div id="clever-image">
        <img id="clever-image-img" src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fit,w_275,g_center,q_auto:best,dpr_1.3,f_auto/homepage/crowdfunding-crowdsurfing_base.svg" alt="">
      </div>

      <div id="clever-details">
        <div id="clever-details-heading">Clever Things For Curious Humans<sup style="font-size: 16px;position: relative; top: -13px">TM</sup></div>
        <div id="clever-details-description">There's no better place to start the hunt for something new and special. Begin on Indiegogo to find clever and unconventional things that solve everyday problems large and small.</div>
